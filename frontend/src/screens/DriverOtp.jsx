...
import {useDriverotpMutation} from '../slices/driversApiSlice.js';
...
console.log("state",state);
  ...
  const [driverotp, { isLoading }] = useDriverotpMutation();
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      ...
      // Verify OTP   
      const res = await driverotp({ email: email, otp }).unwrap();
